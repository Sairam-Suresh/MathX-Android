  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: const [
          ExpansionTile(
            title: Text('What is Math Rendering?'),
            children: [
              Padding(
          ...
          ExpansionTile(
            title: Text('How do you type LaTeX equations?'),
            children: [
              Padding(
                padding: EdgeInsets.symmetric(vertical: 7.5),
                child: Column(
          ...
          ExpansionTile(
            title: Text('What are some examples of LaTeX?'),
            children: [
              Padding(
                padding: EdgeInsets.symmetric(vertical: 7.5),
                child: Column(
                  children: [
                    Row(
                      children: [
                        Expanded(child: Text('Indices/Index - \\[4^7\\]')),
                    ...
                    Row(
                      children: [
                        Expanded(child: Text('Fractions - \\[\\frac{3}{7}\\]')),
